public class App {
    public static void main(String[] args) {
        LivroFisico livro1 = new LivroFisico("Aventuras em Java", "João Autor","Físico");
        ...
        livro1.reservar(); // As mensagens abaixo devem exibir na tela que os livros foram reservados com sucesso
        ebook1.reservar(); // As mensagens abaixo devem exibir na tela que os livros foram reservados com sucesso
